 function stop = emplotfuncount(optimvalues,flag)
%EMPLOTFUNCOUNT Plot function evaluations every iteration.
%   STOP = EMPLOTFUNCOUNT(OPTIMVALUES,FLAG) where OPTIMVALUES is a
...
switch flag
    ...
    set(plotFunC,'Tag','emplotfuncount');
    ...
    case 'iter'
    plotFunC = findobj(get(gca,'Children'),'Tag','emplotfuncount');
