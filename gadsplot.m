...
%
%   This function is private to simulanneal, patternsearch, ga, gamultiobj, emalgorithm.

%   Copyright 2006-2012 The MathWorks, Inc.
%   $Revision: 1.1.6.10 $  $Date: 2012/05/04 00:00:48 $
...
switch lower(strtrim(fname))
    ...
    case 'genetic algorithm'
        ...
        state = optimvalues;
    case 'eletromagnetism-like algorithm'
        state = plotfcn(varargin{1:end}) || state ;
